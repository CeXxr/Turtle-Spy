-- TurtleSpy V1.5.3, credits to cexnpc for finding this fuck yall niggas
...
Code.Text = "Kill Yourself. (Use P to close GUI)"
...
CodeComment.Text = "-- Script found by cexnpc kys :3"
